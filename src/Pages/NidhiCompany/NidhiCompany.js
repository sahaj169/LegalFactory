    ...
    <>
      <Container fixed maxWidth>
        ...
        >
          ...
          >
            <GetInTouchFromPl2 service='Nidhi Company' />
          </DialogContent>
        </Dialog>

        <Navbar bs='NIDHI COMPANY' />
            ...
            <Grid item md={4} xs={12}>
              ...
              >
                <Grid item>
                  ...
                  >
                    Looking for a way to grow your company with the lowest of
                    capital?
                  </Typography>
                </Grid>
                <Grid item sx={{ marginTop: '29px', marginBottom: '40px' }}>
                  ...
                  >
                    Register as a Nidhi Company, Join us now and get a FREE
