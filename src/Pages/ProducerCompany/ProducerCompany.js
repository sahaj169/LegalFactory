...
import Image1 from "../../Assets/Images/pc1.png";
import Image2 from "../../Assets/Images/pc2.png";
...
import PenLeft from "../../Assets/Images/PenLeft.png";
import PenRight from "../../Assets/Images/PenRight.png";
import File from "../../Assets/Images/sp3.png";
import Phone from "../../Assets/Images/sp4.png";
import Message from "../../Assets/Images/sp3.png";
import NoteMobile from "../../Assets/Images/sp3.png";
import PhoneMobile from "../../Assets/Images/sp4.png";
import MessageMobile from "../../Assets/Images/sp3.png";
    ...
    <>
      <Container fixed maxWidth>
        ...
        >
          ...
          >
            <GetInTouchFromPl2 service="Producer Company" />
          </DialogContent>
        </Dialog>

        <Navbar bs="PRODUCER COMPANY" />
        ...
        >
          ...
          >
            ...
            <Grid item md={4} xs={12}>
              ...
              >
                <Grid item>
                  ...
                  >
                    Have the finest produce, register as a Producer Company?
                  </Typography>
                </Grid>
            ...
            >
              ...
              >
                <GetInTouchFromPl service="Producer Company" />
              </div>
            </Grid>
          </Grid>
        </div>
              ...
              <Grid xs={6}>
                ...
                >
                  <Grid item sx={{ marginTop: "111px" }}>
                    ...
                    >
                      Get your company registered as a
                    </Typography>
                  </Grid>
                  <Grid item>
                    <Typography
                  ...
                  <Grid item sx={{ marginTop: "32px" }}>
                    ...
                    >
                      We help you each step of the way until you receive your
                    </Typography>
                  </Grid>
                  <Grid item>
                    <Typography
                    ...
                    >
                      certificate of incorporation by the MCA
                    </Typography>
                  </Grid>
                </Grid>
                <Grid
                ...
                >
                  <Grid md={4} xs={12} sm={12} item sx={{ marginTop: "80px" }}>
                    ...
                    {isRange ? (
                      ...
                      <img src={File} alt="File" height="80px" width="80px" />
                    )}
                    ...
                    >
                      We help you with your company's name reservation. We
                      ensure that the name should have the words PRODUCER
                      COMPANY at the end.
                    </Typography>
                  </Grid>
                  <Grid
                  ...
                  >
                    ...
                    {isRange ? (
                      <img src={Phone} alt="sp4" height="50px" width="50px" />
                    ) : (
                      <img src={Phone} alt="sp4" height="80px" width="80px" />
                    )}
                    <Typography
                      sx={
                        !(isMobile || isTablet) && !isRange && !isRange2
                  ...
                  <Grid md={4} xs={12} sm={12} item sx={{ marginTop: "80px" }}>
                    ...
                    {isRange ? (
                      <img src={Message} alt="sp3" height="50px" width="50px" />
                    ) : (
                      <img src={Message} alt="sp3" height="80px" width="80px" />
                    )}
                    <Typography
                      sx={
                        !(isMobile || isTablet) && !isRange && !isRange2
                    ...
                    >
                      ...
                      company's registration (MoA, AoA, PAN, TAN)
                    </Typography>
                  </Grid>
                </Grid>
              </Grid>
            ...
            <div style={BackgroundSecondHero}>
              <Grid container justifyContent="center" alignItems="center">
                ...
                >
                  ...
                  >
                    Get your company registered as a Producer Company
                  </Typography>
                </Grid>
